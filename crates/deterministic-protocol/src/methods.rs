...
impl Method {
    ...
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            // Phase 9: hybrid patch approval gating
            Self::HybridPatchSubmit => "hybrid.patch.submit",
        }
    }
    ...
    pub fn parse_method(s: &str) -> Option<Self> {
        match s {
            ...
            // Milestone 29
            "queue_view.create" => Some(Self::QueueViewCreate),
            "queue_view.update" => Some(Self::QueueViewUpdate),
            ...
            // Phase 9: hybrid patch approval gating
            "hybrid.patch.submit" => Some(Self::HybridPatchSubmit),
            _ => None,
        }
    }
