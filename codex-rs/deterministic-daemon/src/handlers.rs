...
pub fn dispatch(method: Method, params: serde_json::Value, store: &Store) -> Result<serde_json::Value> {
    match method {
...
fn handle_run_prepare(params: serde_json::Value, store: &Store) -> Result<serde_json::Value> {
...
fn handle_workspace_summary(params: serde_json::Value) -> Result<serde_json::Value> {
    let p: WorkspaceSummaryParams = serde_json::from_value(params)?;
    let result = deterministic_core::workspace_summary::summary(&p)?;
    Ok(serde_json::to_value(result)?)
}

fn handle_file_read(params: serde_json::Value, store: &Store) -> Result<serde_json::Value> {
...
fn handle_git_status(params: serde_json::Value, store: &Store) -> Result<serde_json::Value> {
...
fn handle_code_search(params: serde_json::Value, store: &Store) -> Result<serde_json::Value> {
...
fn handle_patch_apply(params: serde_json::Value, store: &Store) -> Result<serde_json::Value> {
...
fn handle_tests_run(params: serde_json::Value, store: &Store) -> Result<serde_json::Value> {
...
fn handle_git_diff(params: serde_json::Value, store: &Store) -> Result<serde_json::Value> {
